# Governance Server v2

Governance Server v2 is a backend service for the Human Protocol governance system. It aggregates proposals and votes from multiple Ethereum-compatible chains using a hub-and-spoke model, providing a fast and unified REST API for frontend applications.
